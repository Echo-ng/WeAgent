...
export function IconAgent(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      ...
      <path d="M7 18c.5-2 2.5-3.5 5-3.5s4.5 1.5 5 3.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconFlow(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      ...
      <path d="M8 6h8M7.5 8.5L10 15M16.5 8.5L14 15" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconSpark(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" {...props}>
      <path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5L12 2z" strokeLinecap="round" strokeLinejoin="round" />
